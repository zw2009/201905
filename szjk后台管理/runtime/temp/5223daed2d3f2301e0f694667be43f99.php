<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"../application/index/view/default/article\info_linkstore.html";i:1544630728;s:50:"../application/index/view/default/Common\base.html";i:1544630729;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="inner-main">
	...
	<div class="pright">
		<div class="pcontent">
			...
			<div class="oitem">服务项目：<?php echo $data['service']; ?></div>
			<div class="oitem">地&emsp;&emsp;址：<?php echo $data['address']; ?></div>
			<div class="oitem">预约电话：<?php echo $data['tel']; ?></div>
			<div class="content">
