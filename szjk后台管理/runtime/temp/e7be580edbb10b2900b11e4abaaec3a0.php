<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"../application/index/view/mobile/article\list_article.html";i:1544630729;s:49:"../application/index/view/mobile/Common\base.html";i:1544630729;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="inner-list">
	...
	<div class="item">
		<a class="item-title" href="<?php echo url('info',['id'=>$vo['id']]); ?>"><?php echo $vo['title']; ?></a>
		<div class="item-info">更新时间：<?php echo date("Y-m-d H:i:s",$vo['update_time']); ?></div>
