<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\wwwroot\szjk\public/../application/admin\view\common\login.html";i:1544630727;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>思众健康 - 欢迎您登录</title>
...
<script type="text/javascript">
    ...
    $(function(){
        //初始化选中用户名输入框
        $("#itemBox").find("input[name=login_name]").focus();
        //刷新验证码
