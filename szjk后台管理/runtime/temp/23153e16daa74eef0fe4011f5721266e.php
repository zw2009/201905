<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"../application/index/view/default/article\index_article.html";i:1544630728;s:50:"../application/index/view/default/Common\base.html";i:1544630729;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="inner-main">
	<div class="pleft">
		...
		<ul class="mlist">
			...
			<li <?php if($vo['id'] == $data['id']): ?>class="active"<?php endif; ?>><a href="<?php echo url('lists',['cid'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></li>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
	<div class="pright">
