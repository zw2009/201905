<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"../application/index/view/default/article\list_team.html";i:1544630729;s:50:"../application/index/view/default/Common\base.html";i:1544630729;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="inner-main">
    ...
    <ul class="tlist">
        <li <?php if($top_id == \think\Request::instance()->param('cid')): ?>class="active"<?php endif; ?>><a href="<?php echo url('lists',['cid'=>$topcate['id']]); ?>">全部</a></li>
        ...
        <li <?php if($vo['id'] == \think\Request::instance()->param('cid')): ?>class="active"<?php endif; ?>><a href="<?php echo url('lists',['cid'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <div class="plist">
        <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <div class="item">
            <a class="item-img" href="<?php echo url('info',['id'=>$vo['id']]); ?>">
                <img src="<?php echo $vo['thumb']; ?>">
                <div class="name"><?php echo $vo['title']; ?></div>
            </a>
            <div class="item-info">
                <div class="title"><?php echo $vo['service']; ?></div>
                <div class="details">
                    <?php echo $vo['description']; ?>
                </div>
                <div class="more"><a href="<?php echo url('info',['id'=>$vo['id']]); ?>"></a></div>
            </div>
        </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="clearfix"></div>
