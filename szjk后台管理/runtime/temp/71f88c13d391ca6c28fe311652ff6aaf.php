<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"../application/index/view/mobile/article\list_team.html";i:1544630729;s:49:"../application/index/view/mobile/Common\base.html";i:1544630729;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="inner-list">
	...
	<div class="item">
		...
		<div class="item-cont">
			...
			<div class="info">
				<p class="service"><?php echo $vo['service']; ?></p>
				<p class="cont"><?php echo $vo['description']; ?></p>
			</div>
		</div>
	</div>
	<?php endforeach; endif; else: echo "" ;endif; ?>
